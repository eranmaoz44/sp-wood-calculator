...
if __name__ == '__main__':
    ...
    #         ('full', 180, 200)]
    beds = [('windows', 140, 190), ('windows', 140, 190), ('windows', 140, 190), ('windows', 140, 190),
            ('windows', 140, 190), ('windows', 140, 190), ('windows', 120, 190), ('full', 180, 200),
            ('windows', 90, 200), ('full', 160, 200), ('full', 120, 190), ('full', 80, 190), ('full', 90, 200)]
    # beds = []
    counter = {}
    for bed in beds:
    ...
    bed_heads = [('C', 160), ('C', 160), ('C', 140), ('C', 180)]
    ...
    framed_jewish_beds = [('windows', 180,200), ('windows', 160, 190), ('windows', 160, 200)]
    #framed_jewish_beds = []
